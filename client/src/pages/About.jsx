  ...
  return (
    <div className="py-20 px-4 max-w-6xl mx-auto">
      ...
      <p className="mb-4 text-slate-700">
        YoursEstate is a leading real estate agency that specializes in helping
      ...
      <p className="mb-4 text-slate-700">
        ...
        property, we are here to help you step of the way.
      </p>

      <p className="mb-4 text-slate-700">
        Our team of agents has a wealth of experience and knowledge in th real
